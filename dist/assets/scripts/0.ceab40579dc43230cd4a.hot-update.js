	...
	var digitpretify = function digitpretify() {
	  ...
	  var input = document.querySelector('#credit-card-mask'),
	    ...
	    if (newValue.match(regex)) {
	      ...
	      newCursorPosition = oldCursor - checkSeparator(oldCursor, 3) + checkSeparator(oldCursor + (newValue.length - oldValue.length), 4) + (unmask(newValue).length - unmask(oldValue).length);
...
//# sourceMappingURL=0.ceab40579dc43230cd4a.hot-update.js.map